                ...
                <nav id="loja-cab">
                    ...
                    <section>
                        <div class="toy-checkout">
                            <img src="https://cdn.prod.website-files.com/5baddb6a35e113da0e9a4802/5bae12942ca03553bf0d536c_33903-2-plush-toy-transparent-image-min-p-500.png"width="500"height="500" >
                            <br>
                        </div>
                        <div>
                            <article class="toy-lastcheck">
                                <h2>Teddy Bear</h2>
                                <p>Desperte a ternura e o aconchego com nosso adorável urso de pelúcia marrom. Confeccionado com materiais macios e de alta qualidade, ele é perfeito para abraçar e levar para onde quiser. Seus olhos brilhantes e focinho charmoso conquistam crianças e adultos. Ideal para presentear em qualquer ocasião!</p>
                                ...
                                <h2>R$ 35.00</h2>
                                <form action="teddy.php" method="post">
                                    <input type="hidden" name="id" value="<?php echo $id;?>">
                                    <input type="hidden" name="brinquedo" id="brinquedo" value="Teddy">
                                    <input type="hidden" name="preco" id="preco" value="35.00">
